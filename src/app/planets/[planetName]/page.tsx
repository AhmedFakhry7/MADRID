  ...
  if (planet.slug === 'mercury') {
    ...
    description = (
      ...
      description = (
          <div className="space-y-4">
              <div>
                  <h3 className="font-bold text-xl mb-2">موطننا الكوني</h3>
                  <p>مجرة درب التبانة هي مجرة حلزونية ضخمة تحتوي على نظامنا الشمسي. يُقدر أنها تحتوي على ما بين 100 إلى 400 مليار نجم، بالإضافة إلى كواكب وسحب غازية وغبار كوني.</p>
              </div>
              <div>
                  <h3 className="font-bold text-xl mb-2">البنية والموقع</h3>
                  <p>تتكون المجرة من قرص مركزي، وأذرع حلزونية، وهالة كروية. يقع نظامنا الشمسي في أحد الأذرع الحلزونية الثانوية، على بعد حوالي 27,000 سنة ضوئية من مركز المجرة.</p>
              </div>
              <div>
                  <h3 className="font-bold text-xl mb-2">حقائق مذهلة</h3>
                  <ul className="list-disc list-inside space-y-1">
                      <li>يبلغ قطر مجرة درب التبانة حوالي 100,000 سنة ضوئية.</li>
                      <li>تستغرق الشمس حوالي 230 مليون سنة لإكمال دورة واحدة حول مركز المجرة.</li>
                      <li>يوجد في مركز مجرتنا ثقب أسود هائل يُعرف باسم "الرامي أ*".</li>
                  </ul>
              </div>
          </div>
      );
      ...
      description = (
          <div className="space-y-4">
              <div>
                  <h3 className="font-bold text-xl mb-2">وحوش الجاذبية</h3>
                  <p>الثقب الأسود هو منطقة في الفضاء تكون فيها الجاذبية قوية جدًا لدرجة أن لا شيء، ولا حتى الضوء، يمكنه الهروب منها. تتكون الثقوب السوداء عندما تنهار النجوم الضخمة في نهاية حياتها.</p>
              </div>
              <div>
                  <h3 className="font-bold text-xl mb-2">الأنواع والبنية</h3>
                  <p>هناك أنواع مختلفة من الثقوب السوداء، بما في ذلك الثقوب السوداء النجمية والثقوب السوداء فائقة الكتلة. يتكون الثقب الأسود من "الأفق الحدثي"، وهو نقطة اللاعودة، و"التفرد"، وهي النقطة المركزية ذات الكثافة اللانهائية.</p>
              </div>
              <div>
                  <h3 className="font-bold text-xl mb-2">حقائق مذهلة</h3>
                  <ul className="list-disc list-inside space-y-1">
                      <li>لا يمكن رؤية الثقوب السوداء مباشرة، ولكن يمكن اكتشافها من خلال تأثير جاذبيتها على النجوم والمادة المحيطة بها.</li>
                      <li>يؤدي مرور المادة عبر الأفق الحدثي إلى تسخينها وإصدار أشعة سينية قوية.</li>
                      <li>الزمن يتباطأ بالقرب من الثقب الأسود بسبب شدة الجاذبية.</li>
                  </ul>
              </div>
          </div>
      );
